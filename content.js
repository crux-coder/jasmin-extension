(function () {
  ...
  function addElements(challenge) {
    addDescription(challenge.description);
    addInstructions(challenge.instructions);
  }

  function clearHelpers() {
    console.log('TEST');
    chrome.storage.local.get('challengeIndex', function (items) {
      removeElements(responsiveWebDesignChallenges[items.challengeIndex]);
      addElements(responsiveWebDesignChallenges[items.challengeIndex]);
    });
  }
